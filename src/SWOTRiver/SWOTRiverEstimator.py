...
class SWOTRiverEstimator(SWOTL2):
    ...
    def process_reach(self, river_reach_collection, river_reach, reach,
        ...
        # TO-DO: add sic4dvar when we have new SWORD
        reach_stats['dschg_isf'] = MISSING_VALUE_FLT # dsch_m_uc['SIC4DVar']['sbQ_rel']
        ...
        # TO-DO: add sic4dvar when we have new SWORD
        reach_stats['dschg_gisf'] = MISSING_VALUE_FLT # dsch_m_c['SIC4DVar']['sbQ_rel']
